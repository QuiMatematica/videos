...
class Scene(MovingCameraScene):
    ...
    def construct(self):
        ...
        posizioni = [(-1.5, -.15, 0) + 3 * RIGHT, (-.5, .15, 0) + 3 * RIGHT, (.5, .15, 0) + 3 * RIGHT,
                     (1.5, -.15, 0) + 3 * RIGHT]
        rotazioni = [21, 7, -7, -21]
        ...
        self.play(
            *[livello_3[_i // 2][_i % 2].animate.shift(
                delta_v2 * (_i - 11.5) - delta_v2_b * ((_i // 2) - 5.5) - delta_v2_c * ((_i // 6) - 1.5) + delta_h)
              for _i in range(24)],
        )
        self.play(
            *[Create(Line(livello_2[_i // 6][(_i % 6 // 2)][0].get_right(), livello_3[_i // 2][_i % 2][0].get_left(),
                          color=GRAY))
              for _i in range(24)]
        )
        ...
        coppie = VGroup()
        for _i in range(24):
            coppie.add(segnaposti.copy())
        coppie.arrange_in_grid(12, 2, buff=(1, 1))
        coppie.shift(60*RIGHT)

        self.play(
            *[livello_4[0][_i].animate.move_to(coppie[0]) for _i in range(2)],
            *[livello_4[1][_i].animate.move_to(coppie[2]) for _i in range(2)],
            *[livello_4[2][_i].animate.move_to(coppie[4]) for _i in range(2)],
            *[livello_4[3][_i].animate.move_to(coppie[5]) for _i in range(2)],
            *[livello_4[4][_i].animate.move_to(coppie[3]) for _i in range(2)],
            *[livello_4[5][_i].animate.move_to(coppie[1]) for _i in range(2)],
            *[livello_4[6][_i].animate.move_to(coppie[6]) for _i in range(2)],
            *[livello_4[7][_i].animate.move_to(coppie[8]) for _i in range(2)],
            *[livello_4[8][_i].animate.move_to(coppie[10]) for _i in range(2)],
            *[livello_4[9][_i].animate.move_to(coppie[12]) for _i in range(2)],
            *[livello_4[10][_i].animate.move_to(coppie[14]) for _i in range(2)],
            *[livello_4[11][_i].animate.move_to(coppie[16]) for _i in range(2)],
            *[livello_4[12][_i].animate.move_to(coppie[18]) for _i in range(2)],
            *[livello_4[13][_i].animate.move_to(coppie[19]) for _i in range(2)],
            *[livello_4[14][_i].animate.move_to(coppie[20]) for _i in range(2)],
            *[livello_4[15][_i].animate.move_to(coppie[22]) for _i in range(2)],
            *[livello_4[16][_i].animate.move_to(coppie[21]) for _i in range(2)],
            *[livello_4[17][_i].animate.move_to(coppie[23]) for _i in range(2)],
            *[livello_4[18][_i].animate.move_to(coppie[9]) for _i in range(2)],
            *[livello_4[19][_i].animate.move_to(coppie[7]) for _i in range(2)],
            *[livello_4[20][_i].animate.move_to(coppie[15]) for _i in range(2)],
            *[livello_4[21][_i].animate.move_to(coppie[17]) for _i in range(2)],
            *[livello_4[22][_i].animate.move_to(coppie[11]) for _i in range(2)],
