...
class Scene(MovingCameraScene):
    ...
    def construct(self):
        ...
        self.add(intersezione_asse_y)

        testo = VGroup(
            Tex("FUOCO:"),
            MathTex(r"x_F = {{ -\dfrac{b}{2a} }} = 1"),
            MathTex(r"y_F &= \dfrac{1 - \Delta}{4a} = \\ {{ &= \dfrac{1 - 16}{4 \cdot 1} = }} \\ &= -\dfrac{15}{4}"),
            MathTex(r"V (1, -\dfrac{15}{4})"),
