...
class Scene(MovingCameraScene):
    ...
    def construct(self):
        ...
        vertice = MathTex(r"\text{vertice}: \begin{cases} x_V = -\dfrac{b}{2a} \\[2ex] y_V = -\dfrac{\Delta}{4a} \end{cases}")
        vertice[0][:8].set_color(YELLOW)

        fuoco = MathTex(r"\text{fuoco}: \begin{cases} x_F = -\dfrac{b}{2a} \\[2ex] y_F = \dfrac{1-\Delta}{4a} \end{cases}")
