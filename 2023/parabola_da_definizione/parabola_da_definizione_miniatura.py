...
class Scene(MovingCameraScene):
    ...
    def construct(self):
        ...
        title = Title("Determinare l'equazione applicando la definizione", color=GREEN).set_color(GREEN)
        self.add(title)
        ...
        riferimento = Axes(x_range=[x_min, x_max, 1],
                           ...
                           x_length=x_length,
                           y_length=y_length).add_coordinates().set_color(BLUE).set_z_index(-1).shift(.7 * DOWN)
